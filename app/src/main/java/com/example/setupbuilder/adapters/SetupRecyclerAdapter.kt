...
class SetupRecyclerAdapter(val names: ArrayList<String>, val price: ArrayList<String>?, val urls:ArrayList<String>?, val ids:ArrayList<String>?, val search:String) :  RecyclerView.Adapter<SetupRecyclerAdapter.ViewHolder>() {
    //Nome do Setup
